...
export const OFERTAS = [
  ...
  {
    pieza: "dir-hidraulico-media",
    producto: "K-Sport freno de mano hidráulico fly-off. Solo la palanca y el cilindro: los racores y latiguillos van aparte, 60 € más",
    referencia: "KS-ZU-79",
    vendedor: "K-Tec Germany",
    url: "https://www.k-tec-germany.com/K-Sport-hydraulische-Handbremse-/-Fly-Off-Hebel",
    precio: 249.00, moneda: "EUR", fecha: "2026-08-30",
  },
  {
    pieza: "of-faldones-rline",
    producto: "Juego de faldones laterales R-Line originales en negro para Golf 8",
    referencia: "5H0853855041 / 5H0853856041",
    vendedor: "ahw-shop",
    url: "https://shop.ahw-shop.de/original-vw-golf-8-5h-r-line-seitenschweller-set-tuning-schweller-schwarz",
    precio: 548.50, moneda: "EUR", fecha: "2026-08-30",
  },
  {
    pieza: "turbo-bigturbo-alta",
    producto: "Turbo-Total kit de turbo IS38 en posición de origen, más de 600 CV, con tuberías de aceite y agua y kit de montaje",
    referencia: "21tsi226.1",
    vendedor: "BAR-TEK Tuning",
    url: "https://www.bar-tek.com/2.0-tsi-ea888-gen.3-mqb-is38-s-calations-turbocharger-kit-turbo-total",
    precio: 2699.95, moneda: "EUR", fecha: "2026-08-30",
  },
  {
...
export const HOMOLOGACION = {
  ...
  "of-faldones-rline": {
    homologada: ["Alemania", "España"],
    no_homologada: [],
    nota: "Pieza original homologada de fábrica para el modelo, así que no exige reforma en ninguno de los dos países. Es la ventaja de montar accesorio de catálogo en vez de equivalente no oficial.",
  },
  "dir-hidraulico-media": {
    homologada: [],
    no_homologada: ["España"],
    nota: "Corta el circuito de freno trasero para meter un cilindro, así que toca el sistema de frenado. La palanca se vende como componente de competición y sin certificado, y sin papel no hay reforma que legalizar. Uso en circuito o rally con licencia.",
  },
  "est-airride-alta": {
    homologada: ["Alemania", "España"],
    no_homologada: [],
